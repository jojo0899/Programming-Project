	...
	public SearchEventResultList() {
		...
		try (Connection connection = DriverManager.getConnection(url, user , password)){
			...
			table.setModel(new DefaultTableModel(
				...
				new String[] {
					"sportart", "Datum", "Uhrzeit", "Stadt", "Straße", "Hausnummer", "Anzahlplätze", "kosten" //Spaltenname
				}
			) {
		...
		String query = "SELECT sportart, Datum, Uhrzeit, Stadt, Straße, Hausnummer, Anzahlplätze, kosten FROM event WHERE sportart = '" + Event.SearchSport+"' and Datum = '" + Event.SearchDate +"' and Stadt Like '%" + Event.Searchcity + "%' and kosten = '" + Event.SearchKosten +"'";
		...
		while(rs.next()) {
			...
			String data[] = {sportart, Datum, Uhrzeit, Stadt, Straße, Hausnummer, Anzahlplätze, kosten};
