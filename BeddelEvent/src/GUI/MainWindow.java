...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		BtnActiveEvents.setIcon(new ImageIcon("./pic/ActiveEvents.png")); //bild f�r label setzen
		...
		BtnCreateEvent.setIcon(new ImageIcon("./pic/NeuesEvent.png")); //vbild f�r label settten
		...
		BtnHistory.setIcon(new ImageIcon("./pic/Historie.png")); //bild f�r label setten
		...
		BtnSearchEvent.setIcon(new ImageIcon("./pic/Suchen.png"));//bild f�r label setten
